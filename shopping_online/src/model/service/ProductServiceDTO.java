        ...
        do {
            try {
                ...
                if (checkExistVariant == true){
                    ...
                    throw new InvalidChoiceException("Không tồn tại sản phẩm này, vui lòng nhập lại");
                }
            }catch (Exception e){
                e.printStackTrace();
            }
            ...
            try {
                ...
                switch (setChoice) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        PRODUCT_LIST.sort(Comparator.comparingDouble(ProductDTO::getNumberOfProductPurchase));
